...
import { STAFF_ROLES } from '../auth_utils/auth_constants';

interface AuthStaffLoginProps {
  email: string;
...
export function AuthStaffLogin({
  email, setEmail, password, setPassword, role, setRole, onSubmit, loading, error
}: AuthStaffLoginProps) {
