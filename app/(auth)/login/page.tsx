          ...
          <div className="p-6">
            {tab === 'staff' ? (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-sm font-semibold text-gray-700">Student Portal Offline</p>
                <p className="text-xs text-gray-400 mt-1">Student database connection will be established in Phase 2 of development.</p>
              </div>
            )}
          </div>
        </div>
